...
// Just add a check around the immediate call
if (document.readyState === "complete" || document.readyState === "interactive") {
    toggleMenu();
  } else {
    // If DOM isn't ready, wait until it is
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Then add a null check before attaching the event listener
    if (searchIcon) {
        searchIcon.addEventListener('click', () => {
            // Your existing code inside the event listener
        });
    }
